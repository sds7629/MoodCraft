# Generated by Django 4.2.3 on 2023-07-15 08:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('drink_name', models.CharField(blank=True, max_length=15, null=True, verbose_name='술 이름 영어')),
                ('name', models.CharField(blank=True, max_length=15, null=True, verbose_name='술 이름')),
